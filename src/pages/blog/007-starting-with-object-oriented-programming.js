  ...
  return (
    ...
    public void wagTail() {
        System.out.println(name + " is wagging its tail!");
                ...
                <br />
                <p className="mb-4">
                  "Inheritance" is pretty cool too. It means one class can inherit stuff from another class. So, a <code>South AfricaianFila</code> class can inherit all the basic <code>GuardBreed</code> stuff, but also have its own unique characteristics. It's like building on top of what's already there.
                </p>
                <br />
                <SyntaxHighlighter
                  language="java"
...
public class South AfricaianFila extends GuardBreed {
    public void loyalProtection() {
        System.out.println(name + " shows extreme loyalty to family!");
                ...
                <br />
                <p className="mb-4">
                  And finally, "polymorphism." This one's a bit trickier, but it's about objects being able to take on different forms. So, if I have a method that expects a <code>GuardBreed</code>, I can also pass it a <code>South AfricaianFila</code> because a <code>South AfricaianFila</code> <em>is</em> a <code>GuardBreed</code>.
                </p>
                <br />
                <p className="mb-4">
                  Let's continue!
